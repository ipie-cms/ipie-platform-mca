 ...
 *
 * <p>A service declares only the table, exactly as with {@link AbstractOutboxEventJpaEntity}.
 */
@MappedSuperclass
public abstract class AbstractProcessedEventJpaEntity {
    ...
    protected AbstractProcessedEventJpaEntity() {
